...
mixin _$UserInfo {
 ...
 String get name; String get surname; int get age; String get email; String get phone; String get position; List<String> get skills; String get about; String get education; String get experience;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,name,surname,age,email,phone,position,const DeepCollectionEquality().hash(skills),about,education,experience);

@override
String toString() {
  return 'UserInfo(name: $name, surname: $surname, age: $age, email: $email, phone: $phone, position: $position, skills: $skills, about: $about, education: $education, experience: $experience)';
}
...
@useResult
$Res call({
 String name, String surname, int age, String email, String phone, String position, List<String> skills, String about, String education, String experience
});
...
/// Create a copy of UserInfo
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? name = null,Object? surname = null,Object? age = null,Object? email = null,Object? phone = null,Object? position = null,Object? skills = null,Object? about = null,Object? education = null,Object? experience = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String name,  String surname,  int age,  String email,  String phone,  String position,  List<String> skills,  String about,  String education,  String experience)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _UserInfo() when $default != null:
return $default(_that.name,_that.surname,_that.age,_that.email,_that.phone,_that.position,_that.skills,_that.about,_that.education,_that.experience);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String name,  String surname,  int age,  String email,  String phone,  String position,  List<String> skills,  String about,  String education,  String experience)  $default,) {final _that = this;
switch (_that) {
case _UserInfo():
return $default(_that.name,_that.surname,_that.age,_that.email,_that.phone,_that.position,_that.skills,_that.about,_that.education,_that.experience);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String name,  String surname,  int age,  String email,  String phone,  String position,  List<String> skills,  String about,  String education,  String experience)?  $default,) {final _that = this;
switch (_that) {
case _UserInfo() when $default != null:
return $default(_that.name,_that.surname,_that.age,_that.email,_that.phone,_that.position,_that.skills,_that.about,_that.education,_that.experience);case _:
  return null;
...
class _UserInfo implements UserInfo {
  const _UserInfo({required this.name, required this.surname, required this.age, required this.email, required this.phone, required this.position, required final  List<String> skills, required this.about, required this.education, required this.experience}): _skills = skills;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,name,surname,age,email,phone,position,const DeepCollectionEquality().hash(_skills),about,education,experience);
...
/// Create a copy of UserInfo
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? name = null,Object? surname = null,Object? age = null,Object? email = null,Object? phone = null,Object? position = null,Object? skills = null,Object? about = null,Object? education = null,Object? experience = null,}) {
